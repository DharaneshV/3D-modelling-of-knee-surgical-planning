...
def run_ct_case(input_file):
    ...
    seg_cmd = [python_exe, "src/segmentation/run_ct_segmentation.py", "--input", str(input_file), "--output", str(mask_output)]
    ...
    mesh_cmd = [python_exe, "scripts/run_meshing.py", "--input", str(mask_output), "--output_dir", str(task_mesh_dir), "--track", "ct_bone"]
